...
namespace NWeChatInterface.Requests
{
    ...
    public class CreateShortUrl : AccessRequiredRequest<CreateShortUrlResponse>
    {
        ...
        public override string Data { get { return string.Format("{{'action':'{0}', 'long_url':'{1}'}}", this.Action, this.LongUrl).Replace("'", "\""); } }
    }
}
